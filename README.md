...
/www/server/panel/data/compose/xy/nginx/nginx.conf
/www/server/panel/data/compose/xy/nginx/conf.d/tsdd.conf
/www/server/panel/data/compose/xy/nginx/certs/qx_qhfhasina_com.crt
/www/server/panel/data/compose/xy/nginx/certs/qx_qhfhasina_com.key


```shell
rsync -avz docker/tsdd/nginx/ root@47.239.98.68:/www/server/panel/data/compose/xy/nginx/
ssh root@47.239.98.68 "cd /www/server/panel/data/compose/xy && docker compose restart nginx"
```
